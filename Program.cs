...
namespace DeadLetterQueue
{
    ...
    public class Program
    {
        ...
        public static async Task Main(string[] args)
        {
            ...
            string FullQualifiedNamespace = configuration["FullyQualifiedNamespace"];
            string QueueName = configuration["QueueName"];
            string ConnectionString = configuration["ConnectionString"];
            await RunAsync(FullQualifiedNamespace, QueueName, ConnectionString);
        }
        ...
        {
            ServiceBusReceiver receiver = _client != null ? _client.CreateReceiver(queueName) : throw new NullReferenceException("_client is null");
        ...
        private static Task ReceiveMessages(string queueName, CancellationToken cancellationToken)
        {
            ...
            ServiceBusProcessor processor = _client != null ? _client.CreateProcessor(queueName) : throw new NullReferenceException("_client is null");
        ...
        private static Task PickUpAndFixDeadletters(string queueName, ServiceBusSender resubmitSender, CancellationToken cancellationToken)
        {
            ...
            ServiceBusProcessor dlqProcessor =
                _client != null ? _client.CreateProcessor(queueName, new ServiceBusProcessorOptions {SubQueue = SubQueue.DeadLetter}) : throw new NullReferenceException("_client is null");
